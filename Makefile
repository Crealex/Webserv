NAME	= webServ
SRCS	= $(addprefix srcs/, Server.cpp main.cpp printDebug.cpp send.cpp Client.cpp time.cpp Loop.cpp)
...
SOCKET  = $(addprefix srcs/socket/, createSocket.cpp Socket.cpp SocketData.cpp printSocket.cpp closeClient.cpp)
